...
namespace GameAchievements.RequestFeatures.Extensions.DataShaper.Impl
{
    public class DataShaper<T> : IDataShaper<T> where T : class
    {
        ...
        {
            var requredProperties = new List<PropertyInfo>();
            if (!string.IsNullOrWhiteSpace(fieldsString))
            {
                ...
                foreach(var field in fields)
                {
                    ...
                    if (property == null)
                        continue;
                    requredProperties.Add(property);
                }
            }
            else
            {
                requredProperties = Properties.ToList();
            }
            return requredProperties;
        }
